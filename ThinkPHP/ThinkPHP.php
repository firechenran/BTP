...
defined('APP_DEBUG') or define('APP_DEBUG',false);//调试模式状态

if(function_exists('seaAutoLoader')){//自动识别SAE环境
   defined('APP_MODE') or define('APP_MODE', 'sae');
   defined('STORAGE_TYPE') or define('STORAGE_TYPE', 'Sae');
}else{
   defined('APP_MODE') or defined('APP_MODE') or define('APP_MODE', 'common');
...
if(!IS_CLI){
  ...
  if(!defined('_PHP_FILE_')){
      if(IS_CGI){
         $_temp = explod('.php',$_SERVER['PHP_SELF']);
